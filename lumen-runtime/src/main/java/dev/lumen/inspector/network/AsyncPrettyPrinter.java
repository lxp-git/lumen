...
/**
 * Interface that callers need to implement in order to pretty print binary payload received by Lumen
 */
public interface AsyncPrettyPrinter {
  /**
   * Prints the prettified version of payload to output. This method can block
   * for a certain period of time. Note that Lumen may impose arbitrary
   ...
   * before the content is actually pretty printed. Lumen uses this
