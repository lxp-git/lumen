...
import dev.lumen.inspector.jsonrpc.PendingRequestCallback;
...
public class ChromePeerManager {
  ...
  /** Snapshot of currently enabled peers (Network.enable / Log.enable / …). */
  public JsonRpcPeer[] copyReceivingPeers() {
