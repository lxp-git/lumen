...
package dev.lumen.dumpapp.plugins;

import dev.lumen.common.ExceptionUtil;
import dev.lumen.common.Util;
import dev.lumen.dumpapp.ArgsHelper;
import dev.lumen.dumpapp.DumpException;
import dev.lumen.dumpapp.DumpUsageException;
import dev.lumen.dumpapp.DumperContext;
  ...
  private void doUncaughtException(Iterator<String> argsIter) throws DumpException {
    ...
    try {
      ...
      if (ctorWithMessage != null) {
        t = ctorWithMessage.newInstance("Uncaught exception triggered by Lumen");
      } else {
